...
✅ Personalização de cores — escolha a cor da janela e o software gera automaticamente tons harmônicos para os botões (normal, hover e pressionado).
...
Clone o repositório
git clone https://github.com/seu-usuario/copy-past-system.git
Entre na pasta
cd copy-past-system
Execute
python app.py
